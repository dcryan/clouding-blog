			...
			<footer class=" footer font-body">
				<div class="footer__background hide-on-mobile">
					...
					<img class="footer__background-image"
						src="<?php bloginfo('template_url'); ?>/images/footer.svg"
				...
				<div class="footer__content">
					<div class="footer__main content-container">
						<div class="footer__column1">
							<img class="footer__logo"
								src="<?php bloginfo('template_url'); ?>/images/Clouding-Logo-Vertical-White.svg"
								alt="footer logo">
							<div class="footer__copyright show-on-mobile">@Copyright Cloudi NextGen S.L. 2020</div>
							<div class="footer__social-media-icons-container">
								<a href="//facebook.com/Clouding.io">
									<img class="footer__social-media-facebook-icon"
										src="<?php bloginfo('template_url'); ?>/images/social/FB-icon.svg"
										alt="facebook-icon">
								</a>
								<a href="//twitter.com/cloudingio">
									<img class="footer__social-media-twitter-icon"
										src="<?php bloginfo('template_url'); ?>/images/social/TW-icon.svg"
										alt="twitter-icon">
								</a>
								<a href="//instagram.com/cloudingio">
									<img class="footer__social-media-instagram-icon"
										src="<?php bloginfo('template_url'); ?>/images/social/IG-icon.svg"
										alt="instagram-icon">
								</a>
								<a href="//linkedin.com/company/clouding.io">
									<img class="footer__social-media-linkedin-icon"
										src="<?php bloginfo('template_url'); ?>/images/social/LN-icon.svg"
										alt="linkedin-icon">
								</a>
							</div>
						</div>
						...
						<div class="footer__certificados-container">
							<div class="footer__certificado-9001"></div>
							<div class="footer__certificado-27001"></div>
						</div>
					</div>
					...
					<div class="footer__copyright-terms-container content-container hide-on-mobile">
						<div class="footer__copyright">@Copyright Cloudi NextGen S.L. 2020</div>
						<div class="footer__terms">
							<div class="es">Los precios recogidos en este sitio web no incluyen IVA. Políticas y Condiciones
								Legales</div>
							<div class="en">The prices shown on this website do not include taxes. Legal Policies and Conditions
							</div>
